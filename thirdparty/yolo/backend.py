...
TINY_YOLO_BACKEND_PATH  = "/home/saurabh/Desktop/SA-Net/snapshot/tiny_yolo_backend.h5"   # should be hosted on a server
    ...
    def __init__(self, input_size):
        ...
        if input_size[2] == 3:
            try:
                ...
                print("Unable to load backend weigths. Using a fresh model for Tiny")
                print(ex)
        else:
            print('pre trained weights are avaliable just for RGB network.')
